    ...
    <div id="additionalImagesUploaderForm">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <?php
                    echo zen_draw_form('additonal_image_upload', FILENAME_ADDITIONAL_IMAGES_UPLOADER, 'process=uploadAdditionalImage', 'POST', ' id="additonal_image_upload" enctype="multipart/form-data"');
                    ...
                    <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                        <div class="form-group">
                            <label for="looks_image_file">Additional Image File</label>
                            <?php
